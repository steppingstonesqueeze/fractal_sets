...
mandelbrot <- function(width=1600, height=1200, center=0+0i, scale=1.5, max_iter=800, bailout=2.0) {
...
julia <- function(c=0.355+0.355i, width=1600, height=1200, center=0+0i, scale=1.5, max_iter=800, bailout=2.0) {
...
img <- mandelbrot(width=1600, height=1200, center=0+0i, scale=1.5, max_iter=800)
fname <- paste0(plot_dir, "mandelbrot_800.png")
plot_fractal(img, file=fname)

img2 <- julia(c=0.355+0.355i, width=1600, height=1200, center=0+0i, scale=1.5, max_iter=800)
fname <- paste0(plot_dir, "julia_800.png")
